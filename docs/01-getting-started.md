...
!!! bytheway "Dark and Light Mode"
    <div class="two-columns">
       <div>
          *By the way*,<br>
          clicking on your initials on the bottom left you can easily choose the mode of the application builder between Light and Dark Mode or a time-dependent automatic mode.
       </div>
    <div>
...
!!! exercise "Create first application with the Wizard"
    ...
    !!! tip "Create App Using Generative AI"
        The entry **Create App Using Generative AI** is only available, when you've configured a **Generative AI Service** in the Workspace Utilities. The same is valid for the APEX Assistants in the Code Editors.
